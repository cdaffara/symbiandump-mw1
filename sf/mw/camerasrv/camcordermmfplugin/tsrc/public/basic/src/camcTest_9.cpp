...
void CCamcTest_9::NewFileName_008_L()
    {
    ///////////////////////////////////////
    //   ID: CAMC_API.NEWFILENAME_008
    //   Action :
    //        Custom command sent, prepare(), and record() 
    //   Output : 
    //        2nd recorded file has the name 
    ...
    TInt err;
    TFileName fileName;
    AddDriveLetterToPath(_L("recordCIF.mp4"),fileName);
    TFileName newfile;
    AddDriveLetterToPath(_L("NewFileName.mp4"),newfile);
    err = fsSession.Delete( fileName ); 
    if ( ( err != KErrNone ) && ( err != KErrNotFound ) )
    ...
    iCamcTestClient->Start_Active_ObjectL(K_TC9_NewFileNameWhenRecordSecondTimeH264BaselineFileFormat, iUiLevelCameraHandle);
...
void CCamcTest_9::NewFileName_009_L()
    {
    ///////////////////////////////////////
    //   ID: CAMC_API.NEWFILENAME_009
    //   Action :
    //        Custom command sent, prepare(), and record() 
    //   Output : 
    //        2nd recorded file has the name 
    ...
    iCamcTestClient->Start_Active_ObjectL(K_TC9_NewFileNameWhenRecordSecondTimeH264HighFileFormat, iUiLevelCameraHandle);
...
MTest* CCamcTest_9::suiteL ()
    ...
    suite->addTestL(CTestCaller<CCamcTest_9>::NewL(_L8("CAMC_API.NEWFILENAME_008"), &NewFileName_008_L));
    suite->addTestL(CTestCaller<CCamcTest_9>::NewL(_L8("CAMC_API.NEWFILENAME_009"), &NewFileName_009_L));    
#endif
#endif

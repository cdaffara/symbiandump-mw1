...
void CCamcTestClient_9::Start_Active_ObjectL ( TestClient9Actions aAction, TInt aCameraHandle )
    ...
    if ( iAction == K_TC9_NewFileNameWhenRecordSecondTimeDiffFileFormat )
    ...
    else if ( iAction == K_TC9_NewFileNameWhenRecordSecondTimeH264BaselineFileFormat )
        {
    ...
    else if ( iAction == K_TC9_NewFileNameWhenRecordSecondTimeH264HighFileFormat )
        {
        AddDriveLetterToPath(_L("recordCIF.mp4"), file);
        ...
        TRAPD(err,
            ...
            controllerUid,
            formatUidMP4,
            _L8("video/H264; profile-level-id=64400D"),
            TFourCC(' ', 'A', 'A', 'C') ));
...
void CCamcTestClient_9::RunLTrappedL()
    ...
    if ( iOpenReady )  
        ...
        switch ( iAction )
            ...
            case K_TC9_NewFileNameWhenRecordSecondTimeH264HighFileFormat:                
                {

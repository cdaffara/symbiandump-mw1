...
#if !defined(_ABS_AKA_STATE_H_)
#define _ABS_AKA_STATE_H_
...
public:
	 ...
	 */
	virtual ~abs_eap_type_aka_state_c()
	{
	}
	...
	//--------------------------------------------------
}; // class abs_eap_type_aka_state_c



#endif //#if !defined(_ABS_AKA_STATE_H_)

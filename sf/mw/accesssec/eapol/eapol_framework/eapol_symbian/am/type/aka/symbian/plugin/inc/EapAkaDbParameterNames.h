...
_LIT(KK_aut, "K_aut");
_LIT(KK_encr, "K_encr");
_LIT(KReauthCounter, "ReauthCounter");
_LIT(KReauthId, "ReauthId");
_LIT(KPreviousIMSI, "PreviousIMSI");

_LIT(KAKALastFullAuthTime, "EAP_AKA_last_full_authentication_time");

#endif // _EAPAKADBPARAMETERNAMES_H_

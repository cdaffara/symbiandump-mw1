...
public:		
	/**
	* Construction function. Called by ECom after the EAP MSCHAPv2 plugin has been loaded.
...
private:
	...
	// Eap type (EAP-MSCHAPv2 or plain MSCHAPv2)
	eap_type_value_e iEapType;
	
};

#endif // _EAPMSCHAPV2_H_

...
public:		
	...
	/**
	* Construction function for EAP Protected setup. Called by ECom after the DLL has been loaded.
...
protected:
	...
	*/
	CEapProtectedSetup(const TIndexType aIndexType, const TInt aIndex);

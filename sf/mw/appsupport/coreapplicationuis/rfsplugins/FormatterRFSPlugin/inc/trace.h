...
* Contributors:
*
* Description:  Trace definitions for Formatter RFS Plugin
*
*/
...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[RFSP]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[RFSP]: " ##aMsg
...
*/
    ...
    _LIT( KDir, "rfsp" );
    _LIT( KFile, "rfsp_log.txt" );
    _LIT( KFullPath, "c:\\logs\\rfsp\\" );

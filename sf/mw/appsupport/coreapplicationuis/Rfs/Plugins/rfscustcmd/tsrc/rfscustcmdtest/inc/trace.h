...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[rfscustcmdtest]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[ssmpolicybasetest]: " ##aMsg
...
*/
    ...
    _LIT( KDir, "ssmpolicypluginstest" );
    _LIT( KFile, "rfscustcmdtest_log.txt" );
    _LIT( KFullPath, "c:\\logs\\ssmpolicypluginstest\\" );

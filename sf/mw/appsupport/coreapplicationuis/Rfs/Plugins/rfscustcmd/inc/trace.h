...
*
* Description:
* Tracing definitions for the RfsCustCmd project.
*
*/
...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[RFSCMD]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[RFSCMD]: " ##aMsg

...
const TCaseInfo CNetworkStatusTest::Case ( 
    ...
    */ 
    ...
    static TCaseInfoInternal const KCases[] =
        ...
        ENTRY( "[Networkstatus] Get Network Status", GetNetworkStatus ),
...
// -----------------------------------------------------------------------------
// CNetworkStatusTest::PrintTest
// Simple printing to UI test.
// -----------------------------------------------------------------------------
//
TInt CNetworkStatusTest::PrintTest( 
    TTestResult& aResult )
    {
     /* Simple print test */
...
// -----------------------------------------------------------------------------
// CNetworkStatusTest::LoopTest
// Another printing to UI test.
// -----------------------------------------------------------------------------
//
TInt CNetworkStatusTest::LoopTest( TTestResult& aResult )
    {

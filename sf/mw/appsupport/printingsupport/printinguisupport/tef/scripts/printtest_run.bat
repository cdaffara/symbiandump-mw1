...
testexecute.exe z:\printtest\printtest_t_fpr.script
testexecute.exe z:\printtest\printtest_t_stream.script
...
copy c:\logs\testexecute\printtest*.htm e:\logs\testexecute\
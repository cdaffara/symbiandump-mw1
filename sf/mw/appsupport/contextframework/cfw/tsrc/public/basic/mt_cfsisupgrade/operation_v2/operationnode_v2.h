...
* Contributors:
*
* Description:  Operation node v2 class declaration.
*
*/
 ...
 * @since S60 5.0
 */
class COperationNode_V2 : public CCFOperationNode,
...
public:
     ...
     * @since S60 5.0
     * @param None.
     * @return COperationNode_V2
     */
    static COperationNode_V2* NewL( MCFOperationServices& aServices,
        CCFOperationNode* aParent,
        const TDesC& aSource,
        const TDesC& aType,
        const TDesC& aValue );
    static COperationNode_V2* NewLC( MCFOperationServices& aServices,
        CCFOperationNode* aParent,
        const TDesC& aSource,
        const TDesC& aType,
        const TDesC& aValue );
...
private:
    ...
    COperationNode_V2( MCFOperationServices& aServices, CCFOperationNode* aParent );

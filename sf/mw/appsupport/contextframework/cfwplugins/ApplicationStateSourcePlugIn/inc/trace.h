...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[ApplicationSource]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[ApplicationSource]: " ##aMsg
...
*/
    ...
    _LIT( KDir, "ApplicationSource" );
    _LIT( KFile, "ApplicationSource.log" );
    _LIT( KFullPath, "c:\\logs\\ApplicationSource\\" );

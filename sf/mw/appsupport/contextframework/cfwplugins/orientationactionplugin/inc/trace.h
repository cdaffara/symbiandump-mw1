...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[OrientationAction]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[OrientationAction]: " ##aMsg
...
*/
    ...
    _LIT( KDir, "OrientationAction" );
    _LIT( KFile, "OrientationAction.log" );
    _LIT( KFullPath, "c:\\logs\\OrientationAction\\" );

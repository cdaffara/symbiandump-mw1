...
#include "vibratraceconfiguration.hrh"
...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[VibraAction]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[VibraAction]: " ##aMsg
...
*/
    ...
    _LIT( KDir, "vibraaction" );
    _LIT( KFile, "vibraaction.txt" );

...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[DisplaySource]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[DisplaySource]: " ##aMsg
...
*/
    ...
    _LIT( KDir, "DisplaySource" );
    _LIT( KFile, "DisplaySource.log" );
    _LIT( KFullPath, "c:\\logs\\DisplaySource\\" );

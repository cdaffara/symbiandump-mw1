...
*/
CSShdOpCodeAlarmSoundsTemporarilySilenced1Step::CSShdOpCodeAlarmSoundsTemporarilySilenced1Step()
	{
...
*/
TInt CSShdOpCodeAlarmSoundsTemporarilySilenced1Step::Exec_SendReceiveL()
	{
	...
	if(iResultServer == 0)
		...
		if(iSrMessageId >= 0)
			{
			TPckgBuf<TBool> silent;
			iResultSr =	SendReceive(iSrMessageId,TIpcArgs(&silent));
			}
		}
	return iResultServer;
	}

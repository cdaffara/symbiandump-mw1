...
*/
CEASShdOpCodeNumberOfAlarmsActiveInQueue1Step::CEASShdOpCodeNumberOfAlarmsActiveInQueue1Step()
	{
...
*/
TInt CEASShdOpCodeNumberOfAlarmsActiveInQueue1Step::Exec_SendReceiveL()
	{
	...
	if(iResultServer == 0)
		...
		if(iSrMessageId >= 0)
			{
			TPckgBuf<TInt> count;
			iResultSr =	SendReceive(iSrMessageId,TIpcArgs(&count));
			}
		}
	return iResultServer;
	}

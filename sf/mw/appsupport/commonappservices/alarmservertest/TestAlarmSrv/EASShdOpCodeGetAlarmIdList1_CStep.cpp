...
*/
CEASShdOpCodeGetAlarmIdList1Step::CEASShdOpCodeGetAlarmIdList1Step()
	{
...
*/
TInt CEASShdOpCodeGetAlarmIdList1Step::Exec_SendReceiveL()
	{
	...
	if(iResultServer == 0)
		...
		if(iSrMessageId >= 0)
			{
			TPckgBuf<TInt> size;
			iResultSr =	SendReceive(iSrMessageId,TIpcArgs(0, &size));
			}
		}
	return iResultServer;
	}

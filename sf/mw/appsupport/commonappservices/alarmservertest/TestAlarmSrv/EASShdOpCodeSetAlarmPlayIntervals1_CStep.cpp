...
*/
CEASShdOpCodeSetAlarmPlayIntervals1Step::CEASShdOpCodeSetAlarmPlayIntervals1Step()
	{
...
*/
TInt CEASShdOpCodeSetAlarmPlayIntervals1Step::Exec_SendReceiveL()
	{
	...
	if(iResultServer == 0)
		...
		if(iSrMessageId >= 0)
			{
			TBuf8<1> buffer;
			iResultSr =	SendReceive(iSrMessageId,TIpcArgs(&buffer, 1));
			}
		}
	return iResultServer;
	}

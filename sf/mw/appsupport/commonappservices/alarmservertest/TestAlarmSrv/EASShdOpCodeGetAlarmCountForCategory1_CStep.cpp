...
*/
CEASShdOpCodeGetAlarmCountForCategory1Step::CEASShdOpCodeGetAlarmCountForCategory1Step()
	{
...
*/
TInt CEASShdOpCodeGetAlarmCountForCategory1Step::Exec_SendReceiveL()
	{
	...
	if(iResultServer == 0)
		...
		if(iSrMessageId >= 0)
			{
			TPckgBuf<TInt> count;
			iResultSr =	SendReceive(iSrMessageId,TIpcArgs(0,&count));
			}
		}
	return iResultServer;
	}

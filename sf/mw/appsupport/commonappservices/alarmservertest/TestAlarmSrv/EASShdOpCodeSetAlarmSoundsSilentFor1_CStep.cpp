...
*/
CEASShdOpCodeSetAlarmSoundsSilentFor1Step::CEASShdOpCodeSetAlarmSoundsSilentFor1Step()
	{
	...
	TCapability cap[] = {ECapabilityWriteDeviceData, ECapability_Limit};
...
*/
TInt CEASShdOpCodeSetAlarmSoundsSilentFor1Step::Exec_SendReceiveL()
	{
	...
	if(iResultServer == 0)
		...
		if(iSrMessageId >= 0)
			{
			TPckgBuf<TTimeIntervalMinutes> interval;
			iResultSr =	SendReceive(iSrMessageId,TIpcArgs(&interval));
			}
		}
	return iResultServer;
	}

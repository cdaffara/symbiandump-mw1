...
*/
CEASShdOpCodeGetAvailableCategoryList1Step::CEASShdOpCodeGetAvailableCategoryList1Step()
	{
...
*/
TInt CEASShdOpCodeGetAvailableCategoryList1Step::Exec_SendReceiveL()
	{
	...
	if(iResultServer == 0)
		...
		if(iSrMessageId >= 0)
			{
			TPckgBuf<TInt> size;
			iResultSr =	SendReceive(iSrMessageId,TIpcArgs(&size));
			}
		}
	return iResultServer;
	}

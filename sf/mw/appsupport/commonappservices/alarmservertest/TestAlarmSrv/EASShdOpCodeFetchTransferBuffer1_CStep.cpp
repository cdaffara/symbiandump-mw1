...
*/
CEASShdOpCodeFetchTransferBuffer1Step::CEASShdOpCodeFetchTransferBuffer1Step()
	{
...
*/
TInt CEASShdOpCodeFetchTransferBuffer1Step::Exec_SendReceiveL()
	{
	...
	if(iResultServer == 0)
		...
		if(iSrMessageId >= 0)
			{
			TBuf8<1> transBuffer;
			iResultSr =	SendReceive(iSrMessageId,TIpcArgs(&transBuffer));
			}
		}
	return iResultServer;
	}

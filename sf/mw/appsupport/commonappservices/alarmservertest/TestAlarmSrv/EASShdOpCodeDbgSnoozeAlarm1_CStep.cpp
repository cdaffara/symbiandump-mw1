...
*/
CEASShdOpCodeDbgSnoozeAlarm1Step::CEASShdOpCodeDbgSnoozeAlarm1Step()
	{
...
*/
TInt CEASShdOpCodeDbgSnoozeAlarm1Step::Exec_SendReceiveL()
	{
	...
	if(iResultServer == 0)
		...
		if(iSrMessageId >= 0)
			...
			TPckgBuf<TTime> time;
			iResultSr =	SendReceive(iSrMessageId,TIpcArgs(&id,&time));
			}
		}
	return iResultServer;
	}

...
*/
CEASShdOpCodeSetAlarmCharacteristics_DifferentSID1Step::CEASShdOpCodeSetAlarmCharacteristics_DifferentSID1Step()
	{
...
*/
TInt CEASShdOpCodeSetAlarmCharacteristics_DifferentSID1Step::Exec_SendReceiveL()
	{
	...
	if(iResultServer == 0)
		...
		if(iSrMessageId >= 0)
			...
			if(alarmId >= 0)
				...
				TAlarmCharacteristicsFlags characteristics = EAlarmCharacteristicsSessionSpecific;
				TPckgC<TAlarmCharacteristicsFlags> package(characteristics);
				TIpcArgs args(alarmId,&package);

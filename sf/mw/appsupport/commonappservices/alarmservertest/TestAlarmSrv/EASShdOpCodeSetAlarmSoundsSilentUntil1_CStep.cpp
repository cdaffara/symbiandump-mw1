...
*/
CEASShdOpCodeSetAlarmSoundsSilentUntil1Step::CEASShdOpCodeSetAlarmSoundsSilentUntil1Step()
	{
...
*/
TInt CEASShdOpCodeSetAlarmSoundsSilentUntil1Step::Exec_SendReceiveL()
	{
	...
	if(iResultServer == 0)
		...
		if(iSrMessageId >= 0)
			{
			TPckgBuf<TTime> time;
			iResultSr =	SendReceive(iSrMessageId,TIpcArgs(&time));
			}
		}
	return iResultServer;
	}

...
* Contributors:
*
* Description:  Declaration of CGSAccWiredCarkitContainer class
*
*/


#ifndef GSACCWIREDCARKITCONTAINER_H
#define GSACCWIREDCARKITCONTAINER_H

#include "gsaccbasecontainer.h"

/**
*  CGSAccWiredCarkitContainer container class
*
*  container class for Carkit view
*/
class CGSAccWiredCarkitContainer : public CGSAccBaseContainer
    {
...
public: // Constructors and destructor
    ...
    */
    CGSAccWiredCarkitContainer( CGSAccessoryPluginModel& aModel );

    /**
    * Destructor.
    */
    virtual ~CGSAccWiredCarkitContainer();
...
#endif // GSACCWIREDCARKITCONTAINER_H

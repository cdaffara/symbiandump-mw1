...
*
* Description:
* Tracing definitions for the SysErrCmd project.
*
*/
...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[SYSERRCMD]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[SSMCMD]: " ##aMsg

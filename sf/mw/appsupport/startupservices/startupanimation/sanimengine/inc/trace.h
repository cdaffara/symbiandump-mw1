...
*/
#define _PREFIX_TRACE( aMsg ) TPtrC( (const TText*)L"[SANIM]: " L##aMsg )
...
*/
#define _PREFIX_CHAR( aMsg ) (const char*)"[SANIM]: " ##aMsg
...
*/
    ...
    _LIT( KDir, "SANIM" );
    _LIT( KFile, "SANIM_log.txt" );
    _LIT( KFullPath, "c:\\logs\\SANIM\\" );
...
//
    ...
    */
        ...
        #define INFO( aMsg )\
            {\
            RFileLogger::Write( \
                KDir, KFile, EFileLoggingModeAppend, _PREFIX_INFO( aMsg ) );\
            }
        #define INFO_1( aMsg, aP1 )\
            {\
            RFileLogger::WriteFormat( \
                KDir, KFile, EFileLoggingModeAppend, _PREFIX_INFO( aMsg ), aP1 );\
            }
        #define INFO_2( aMsg, aP1, aP2 )\
            {\
            RFileLogger::WriteFormat( \
                KDir, KFile, EFileLoggingModeAppend, _PREFIX_INFO( aMsg ), aP1, aP2 );\
            }
        #define INFO_3( aMsg, aP1, aP2, aP3 )\
            {\
            RFileLogger::WriteFormat( \
                KDir, KFile, EFileLoggingModeAppend, _PREFIX_INFO( aMsg ), aP1, aP2, aP3 );\
            }

...
public:
    ...
    HbStyleOptionDataGroupHeadingWidget(const HbStyleOptionDataGroupHeadingWidget &other);
    ~HbStyleOptionDataGroupHeadingWidget();

    enum StyleOptionType { Type = HbSO_DataGroupHeadingWidget };
...
#endif // HBSTYLEOPTIONDATAGROUPHEADINGWIDGET_H

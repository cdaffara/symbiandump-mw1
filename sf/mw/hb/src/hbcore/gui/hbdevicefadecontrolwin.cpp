...
HbDeviceFadeControl::HbDeviceFadeControl(QObject *parent) : QObject(parent), d(0)
{
}
...
// Get background fading-off command
...
{
    return false; // no device dialog server on Win/Linux
}

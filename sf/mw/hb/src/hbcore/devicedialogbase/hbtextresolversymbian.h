...
#ifndef HBTEXTRESOLVERSYMBIAN_H
#define HBTEXTRESOLVERSYMBIAN_H
...
public:
    ...
    IMPORT_C static HBufC* LoadL(const TDesC& aMessageId, TInt aPlural = -1);
    IMPORT_C static HBufC* LoadL(const TDesC& aMessageId, const TDesC& aString, TInt aPlural = -1);        

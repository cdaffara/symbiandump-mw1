...
#ifndef HBEFFECTTHEME_H
#define HBEFFECTTHEME_H

#include <hbglobal.h>
#include <QObject>

class HbEffectThemePrivate;
class TestHbEffectTheme;

class HB_AUTOTEST_EXPORT HbEffectTheme
{
public:
    HbEffectTheme();
    ~HbEffectTheme();

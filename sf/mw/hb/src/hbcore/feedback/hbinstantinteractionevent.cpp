...
HbInstantInteractionEvent::HbInstantInteractionEvent(const HbWidget *widget, Hb::InstantInteraction interaction, Hb::InteractionModifiers modifiers)
    : QEvent((QEvent::Type)HbInstantInteractionEvent::InstantInteraction), m_widget(widget), m_interaction(interaction), m_modifiers(modifiers)
{
}

HbInstantInteractionEvent::~HbInstantInteractionEvent()
{
}

...
#ifndef HBICONANIMATIONMANAGER_H
#define HBICONANIMATIONMANAGER_H
...
class HB_CORE_EXPORT HbIconAnimationManager
{
public:
...
private:
    Q_DISABLE_COPY(HbIconAnimationManager)
    HbIconAnimationManagerPrivate *d;
    friend class HbIconAnimationManagerPrivate;
};

#endif // HBICONANIMATIONMANAGER_H

...
TEMPLATE = lib
TARGET = $$hbLibraryTarget(HbDeviceProgressDialogPlugin)
CONFIG += plugin
...
HEADERS += $$PWD/hbdeviceprogressdialogplugin_p.h
HEADERS += $$PWD/hbdeviceprogressdialogwidget_p.h

SOURCES += $$PWD/hbdeviceprogressdialogplugin.cpp
SOURCES += $$PWD/hbdeviceprogressdialogwidget.cpp

symbian {
    TARGET.EPOCALLOWDLLDATA=1
    TARGET.CAPABILITY = CAP_GENERAL_DLL
    TARGET.UID3 = 0x20022FC8

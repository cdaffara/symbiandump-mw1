...
#ifndef HBDEVICEPROGRESSDIALOGPLUGIN_P_H
#define HBDEVICEPROGRESSDIALOGPLUGIN_P_H
...
class HbDeviceProgressDialogPlugin : public HbDeviceDialogPlugin
{
    Q_OBJECT

public:
    friend class HbDeviceProgressDialogPluginPrivate;

    HbDeviceProgressDialogPlugin();
    ~HbDeviceProgressDialogPlugin();
...
private:
    ...
    HbDeviceProgressDialogPluginPrivate *d;
};

#endif // HBDEVICEPROGRESSDIALOGPLUGIN_P_H

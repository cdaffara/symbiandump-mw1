...
#ifndef HBDEVICENOTIFICATIONDIALOGPLUGIN_P_H
#define HBDEVICENOTIFICATIONDIALOGPLUGIN_P_H
...
class HbDeviceNotificationDialogPlugin : public HbDeviceDialogPlugin
{
    Q_OBJECT

public:
    friend class HbDeviceNotificationDialogPluginPrivate;

    HbDeviceNotificationDialogPlugin();
    ~HbDeviceNotificationDialogPlugin();
...
private:
    ...
    HbDeviceNotificationDialogPluginPrivate *d;
};

#endif // HBDEVICENOTIFICATIONDIALOGPLUGIN_P_H

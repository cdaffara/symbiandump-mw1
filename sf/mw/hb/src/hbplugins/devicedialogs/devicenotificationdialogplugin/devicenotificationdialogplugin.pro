...
TEMPLATE = lib
TARGET = $$hbLibraryTarget(HbDeviceNotificationDialogPlugin)
CONFIG += plugin
...
HEADERS += $$PWD/hbdevicenotificationdialogplugin_p.h
HEADERS += $$PWD/hbdevicenotificationdialogwidget_p.h

SOURCES += $$PWD/hbdevicenotificationdialogplugin.cpp
SOURCES += $$PWD/hbdevicenotificationdialogwidget.cpp

symbian: {
    TARGET.EPOCALLOWDLLDATA = 1
    TARGET.CAPABILITY = CAP_GENERAL_DLL
    TARGET.UID3 = 0x20022FC7

...
**
****************************************************************************/
#ifndef HB_INPUT_MODE_HANDLER_H
#define HB_INPUT_MODE_HANDLER_H

#include "hbinputmodehandler.h"

class HbInputModeHandlerPrivate: public HbPredictionCallback
{
    Q_DECLARE_PUBLIC(HbInputModeHandler)
public:
    HbInputModeHandlerPrivate();
    virtual ~HbInputModeHandlerPrivate();

    HbInputModeHandler *q_ptr;

...
**
****************************************************************************/
#ifndef HB_INPUT_BASIC_12KEY_HANDLER
#define HB_INPUT_BASIC_12KEY_HANDLER

#include "hbinputmodehandler.h"

class HbInputBasic12KeyHandlerPrivate;
class HbInputBasic12KeyHandler: public HbInputBasicHandler
{
    Q_OBJECT
public:
    HbInputBasic12KeyHandler(HbInputAbstractMethod* inputMethod);
...
#endif //HB_INPUT_BASIC_12KEY_HANDLER

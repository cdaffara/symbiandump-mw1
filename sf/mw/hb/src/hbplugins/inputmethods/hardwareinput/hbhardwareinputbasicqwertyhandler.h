...
**
****************************************************************************/
#ifndef HB_HARDWARE_INPUT_BASIC_QWERTY_HANDLER
#define HB_HARDWARE_INPUT_BASIC_QWERTY_HANDLER

#include "hbinputmodehandler.h"

class HbHardwareInputBasicQwertyHandlerPrivate;
class HbHardwareInputBasicQwertyHandler: public HbInputBasicHandler
{
    Q_OBJECT
public:
...
private:
    Q_DECLARE_PRIVATE(HbHardwareInputBasicQwertyHandler)
};

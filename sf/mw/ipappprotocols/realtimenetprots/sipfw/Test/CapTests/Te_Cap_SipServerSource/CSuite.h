...
#if (!defined CAP_Te_Cap_SipServer_SERVER_H_)
#define CAP_Te_Cap_SipServer_SERVER_H_
...
//
// Description:
// TS_Te_Cap_SipServerServer.h
// This contains CTestTe_Cap_SipServerSuite
// 
//
...
class  CTestTe_Cap_SipServerServer : public CTestServer
{
public:
	static CTestTe_Cap_SipServerServer* NewL();
...
//	void ServerClose(RTelServer& aServer);
	...
	TInt StartServer() ;
	TInt CreateServerProcess (RSemaphore& aSemaphore);
...
#endif /* TS_Te_Cap_SipServer_SERVER_H_ */

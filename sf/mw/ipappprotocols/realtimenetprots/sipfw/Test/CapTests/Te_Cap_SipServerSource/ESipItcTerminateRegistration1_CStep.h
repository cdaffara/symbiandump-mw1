...
#ifndef ESipItcTerminateRegistration1_H_
#define ESipItcTerminateRegistration1_H_
...
class CESipItcTerminateRegistration1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcTerminateRegistration1Step() ;

...
#ifndef ESipItcGetRefreshInterval1_H_
#define ESipItcGetRefreshInterval1_H_
...
class CESipItcGetRefreshInterval1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcGetRefreshInterval1Step() ;

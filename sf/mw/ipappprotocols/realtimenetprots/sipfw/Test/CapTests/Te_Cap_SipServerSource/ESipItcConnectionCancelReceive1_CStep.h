...
#ifndef ESipItcConnectionCancelReceive1_H_
#define ESipItcConnectionCancelReceive1_H_
...
class CESipItcConnectionCancelReceive1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcConnectionCancelReceive1Step() ;

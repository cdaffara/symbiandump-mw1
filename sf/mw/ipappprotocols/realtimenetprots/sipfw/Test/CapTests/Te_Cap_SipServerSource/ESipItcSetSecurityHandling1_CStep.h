...
#ifndef ESipItcSetSecurityHandling1_H_
#define ESipItcSetSecurityHandling1_H_
...
class CESipItcSetSecurityHandling1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcSetSecurityHandling1Step() ;

...
#ifndef ESipItcGetCompartmentCount1_H_
#define ESipItcGetCompartmentCount1_H_
...
class CESipItcGetCompartmentCount1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcGetCompartmentCount1Step() ;

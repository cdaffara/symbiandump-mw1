...
#ifndef ESipItcSendResponseInDialog1_H_
#define ESipItcSendResponseInDialog1_H_
...
class CESipItcSendResponseInDialog1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcSendResponseInDialog1Step() ;

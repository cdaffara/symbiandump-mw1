...
#ifndef ESipItcConnectionReceiveSipMessage1_H_
#define ESipItcConnectionReceiveSipMessage1_H_
...
class CESipItcConnectionReceiveSipMessage1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcConnectionReceiveSipMessage1Step() ;

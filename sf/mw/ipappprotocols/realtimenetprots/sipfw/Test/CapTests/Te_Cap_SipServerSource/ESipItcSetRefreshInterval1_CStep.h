...
#ifndef ESipItcSetRefreshInterval1_H_
#define ESipItcSetRefreshInterval1_H_
...
class CESipItcSetRefreshInterval1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcSetRefreshInterval1Step() ;

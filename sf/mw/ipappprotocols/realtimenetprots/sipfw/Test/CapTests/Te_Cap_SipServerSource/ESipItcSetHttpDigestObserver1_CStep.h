...
#ifndef ESipItcSetHttpDigestObserver1_H_
#define ESipItcSetHttpDigestObserver1_H_
...
class CESipItcSetHttpDigestObserver1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcSetHttpDigestObserver1Step() ;

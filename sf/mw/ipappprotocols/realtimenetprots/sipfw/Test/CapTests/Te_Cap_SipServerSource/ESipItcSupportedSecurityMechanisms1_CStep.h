...
#ifndef ESipItcSupportedSecurityMechanisms1_H_
#define ESipItcSupportedSecurityMechanisms1_H_
...
class CESipItcSupportedSecurityMechanisms1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcSupportedSecurityMechanisms1Step() ;

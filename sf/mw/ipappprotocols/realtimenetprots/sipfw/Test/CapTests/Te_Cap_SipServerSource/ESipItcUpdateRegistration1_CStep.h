...
#ifndef ESipItcUpdateRegistration1_H_
#define ESipItcUpdateRegistration1_H_
...
class CESipItcUpdateRegistration1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcUpdateRegistration1Step() ;

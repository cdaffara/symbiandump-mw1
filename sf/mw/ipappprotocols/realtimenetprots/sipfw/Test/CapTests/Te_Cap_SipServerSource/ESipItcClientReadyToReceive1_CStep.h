...
#ifndef ESipItcClientReadyToReceive1_H_
#define ESipItcClientReadyToReceive1_H_
...
class CESipItcClientReadyToReceive1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcClientReadyToReceive1Step() ;

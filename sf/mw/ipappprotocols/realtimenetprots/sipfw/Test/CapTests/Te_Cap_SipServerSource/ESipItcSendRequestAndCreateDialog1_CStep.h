...
#ifndef ESipItcSendRequestAndCreateDialog1_H_
#define ESipItcSendRequestAndCreateDialog1_H_
...
class CESipItcSendRequestAndCreateDialog1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcSendRequestAndCreateDialog1Step() ;

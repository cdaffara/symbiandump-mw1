...
#ifndef ESipItcGetTransactionState1_H_
#define ESipItcGetTransactionState1_H_
...
class CESipItcGetTransactionState1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcGetTransactionState1Step() ;

...
#ifndef ESipItcIsSigCompSupported1_H_
#define ESipItcIsSigCompSupported1_H_
...
class CESipItcIsSigCompSupported1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcIsSigCompSupported1Step() ;

...
CESipItcGetRefreshInterval1Step::CESipItcGetRefreshInterval1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CESipItcGetRefreshInterval1Step");
...
*/
TInt CESipItcGetRefreshInterval1Step::Exec_SendReceive()
	{

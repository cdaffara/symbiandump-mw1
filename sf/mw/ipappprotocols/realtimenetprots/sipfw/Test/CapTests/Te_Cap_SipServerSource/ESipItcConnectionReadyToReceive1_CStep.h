...
#ifndef ESipItcConnectionReadyToReceive1_H_
#define ESipItcConnectionReadyToReceive1_H_
...
class CESipItcConnectionReadyToReceive1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcConnectionReadyToReceive1Step() ;

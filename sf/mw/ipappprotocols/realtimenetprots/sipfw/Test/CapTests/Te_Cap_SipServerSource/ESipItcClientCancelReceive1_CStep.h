...
#ifndef ESipItcClientCancelReceive1_H_
#define ESipItcClientCancelReceive1_H_
...
class CESipItcClientCancelReceive1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcClientCancelReceive1Step() ;

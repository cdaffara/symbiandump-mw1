...
CESipItcGetCompartmentCount1Step::CESipItcGetCompartmentCount1Step()
/** Each test step initialises it's own name
*/
	{
	// store the name of this test case
	// this is the name that is used by the script file
	//DEF iTestStepName = _L("CESipItcGetCompartmentCount1Step");
...
*/
TInt CESipItcGetCompartmentCount1Step::Exec_SendReceive()
	{

...
#ifndef ESipItcSendRequestInDialog1_H_
#define ESipItcSendRequestInDialog1_H_
...
class CESipItcSendRequestInDialog1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcSendRequestInDialog1Step() ;

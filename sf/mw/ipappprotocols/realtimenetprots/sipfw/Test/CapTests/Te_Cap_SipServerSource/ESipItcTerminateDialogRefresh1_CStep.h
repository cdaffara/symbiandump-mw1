...
#ifndef ESipItcTerminateDialogRefresh1_H_
#define ESipItcTerminateDialogRefresh1_H_
...
class CESipItcTerminateDialogRefresh1Step: public CCapabilityTestStep
	{
...
public:
	...
	CESipItcTerminateDialogRefresh1Step() ;

...
*       (Note:This file has to be separate from the logging header file to be
*           able to include it in mmp file. If not we will get warning about
*			not used flogger.lib in other logging cases where flogger.lib 
*           is not used.)
*
*/
...
#ifndef GS_SIP_PLUGIN_CONF_H
#define GS_SIP_PLUGIN_CONF_H
...
*/
#define _GS_SIP_LOGGING_TO_FILE

#endif // _DEBUG

#endif // GS_SIP_PLUGIN_CONF_H

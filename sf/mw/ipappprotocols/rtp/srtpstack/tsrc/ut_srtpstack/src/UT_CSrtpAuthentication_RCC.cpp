...
// CONSTRUCTION
UT_CSrtpAuthentication_RCC* UT_CSrtpAuthentication_RCC::NewL()
    {
    UT_CSrtpAuthentication_RCC* self = UT_CSrtpAuthentication_RCC::NewLC(); 
    CleanupStack::Pop();

    return self;
    }

UT_CSrtpAuthentication_RCC* UT_CSrtpAuthentication_RCC::NewLC()
    {
    UT_CSrtpAuthentication_RCC* self = new( ELeave ) UT_CSrtpAuthentication_RCC();
...
UT_CSrtpAuthentication_RCC::~UT_CSrtpAuthentication_RCC()
    {
    }
...
void UT_CSrtpAuthentication_RCC::ConstructL()
    {
